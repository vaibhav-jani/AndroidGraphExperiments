...
public class ABox extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        points1.add(new SurfacePoint(-2 * 2, 1));
        points1.add(new SurfacePoint(2 * 2, 1));
        points1.add(new SurfacePoint(2 * 2, -3));
        points1.add(new SurfacePoint(-2 * 2, -3));
        points1.add(new SurfacePoint(-2 * 2, 1));

        points1.add(new SurfacePoint(-1 * 2, 3));
        points1.add(new SurfacePoint(3 * 2, 3));
        points1.add(new SurfacePoint(2 * 2, 1));
        points1.add(new SurfacePoint(2 * 2, -3));
        points1.add(new SurfacePoint(3 * 2, -1));
        points1.add(new SurfacePoint(3 * 2, 3));
        points1.add(new SurfacePoint(3 * 2, -1));
        points1.add(new SurfacePoint(2 * 2, -3));
        points1.add(new SurfacePoint(-2 * 2, -3));
        points1.add(new SurfacePoint(-1 * 2, -1));
        points1.add(new SurfacePoint(-1 * 2, 3));
        points1.add(new SurfacePoint(-1 * 2, -1));
        points1.add(new SurfacePoint(3 * 2, -1));
        ...
        points2.add(new SurfacePoint(3 * 2, -1));
        points2.add(new SurfacePoint(-2 * 2, 1));
		...
		pathAttributes2.setPathColor("#FF0000");*/
        points3.add(new SurfacePoint(-2 * 2, -3));
        points3.add(new SurfacePoint(3 * 2, 3));
        Curve path3 = new Curve(points3, pathAttributes2);

        ArrayList<SurfacePoint> points4 = new ArrayList<SurfacePoint>();
		/*PathAttributes pathAttributes2 = new PathAttributes();
		pathAttributes2.setPathColor("#FF0000");*/
        points4.add(new SurfacePoint(-1 * 2, 3));
        points4.add(new SurfacePoint(2 * 2, -3));
        Curve path4 = new Curve(points4, pathAttributes2);

        ArrayList<SurfacePoint> points5 = new ArrayList<SurfacePoint>();
		/*PathAttributes pathAttributes2 = new PathAttributes();
		pathAttributes2.setPathColor("#FF0000");*/
        points5.add(new SurfacePoint(-1 * 2, -1));
        points5.add(new SurfacePoint(2 * 2, 1));
